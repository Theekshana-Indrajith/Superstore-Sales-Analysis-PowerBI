...
1.Extraction: Connected and imported raw datasets from CSV/Excel sources.
...
3.Data Modeling: Established a star-schema-inspired model to ensure efficient filtering and high-performance DAX calculations.
